// import {google} from './googleChartsLoader.js';
(function(){/*
...
template.innerHTML = `
    ...
    #dashboard-grid{
        position: relative;
        font-family: 'Verla Round', sans-serif;
        height: 700px;
        width: 1280px;
        margin: auto;
        display: grid;
    ...
    .charts-item.coming-up{
        cursor: auto;
        box-shadow: none !important;
    }

    .charts-item.coming-up .charts-header .more-link{
        display: none;
    }

    .charts-item.underway{
    ...
    .charts-item:hover .charts-header .charts-title-text{
        font-weight: bold;
    }
    ...
    .info-icon-container:hover .info-container{
        display: flex;
    ...
    .shimmer{
        mask-image: linear-gradient(90deg, black 0%, black 40%, transparent 50%, black 60%, black 100%);
        -webkit-mask-image:linear-gradient(90deg, black 0%, black 40%, transparent 50%, black 60%, black 100%);
        mask-size: 250%;
    ...
    <div id="dashboard-grid">
        <div class="grid-area-wrapper"></div>
        <div class="grid-area-wrapper"></div>
        <div class="grid-area-wrapper"></div>
        <div class="grid-area-wrapper"></div>
...
const gridAreaLayoutTemplate = document.createElement('template');
gridAreaLayoutTemplate.innerHTML = `
    <div class="grid-area">
        <div class="grid-area-header">
            <a class="back-link">Go back</a>
            <p class="grid-area-title"></p>
            <a class="more-link">see more</a>
        </div>
        <div class="grid-area-article">
        </div>
    </div>
`;

const chartsItemTemplate = document.createElement('template');
chartsItemTemplate.innerHTML = `
    <div class="charts-item">
        <div class="charts-header">
            <a class="more-link">see more</a>
            <div class="charts-title-container">
                <span class="charts-title-text"><span>
            </div>
        </div>
        <div class="charts-article"></div>
    </div>
`;

const EstablishmentOccupancyGridItemTemplate = document.createElement('template');
EstablishmentOccupancyGridItemTemplate.innerHTML = `
    <div id="establishment-occupancy-item">
        <div id="occupancy-pictogram">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="37.5 7.5 50 120" fill="black" stroke="#aaaaaa" stroke-width="0.5">
            <linearGradient id="Gradient" x1="0" x2="1" y1="0" y2="0">
                <stop offset="0%" stop-color="black"/>
                <stop offset="60%" stop-color="white"/>
                <stop offset="100%" stop-color="white"/>
            </linearGradient>
                <path d="m62.096 8.5859c-5.208 0-9.424 4.2191-9.424 9.4261 0.001 5.203 4.217 9.424 9.424 9.424 5.202 0 9.422-4.221 9.422-9.424 0-5.208-4.22-9.4261-9.422-9.4261zm-10.41 21.268c-6.672 0-12.131 5.407-12.131 12.07v29.23c0 2.275 1.791 4.123 4.07 4.123 2.28 0 4.127-1.846 4.127-4.123v-26.355h2.102s0.048 68.811 0.048 73.331c0 3.05 2.478 5.53 5.532 5.53 3.052 0 5.525-2.48 5.525-5.53v-42.581h2.27v42.581c0 3.05 2.473 5.53 5.531 5.53 3.054 0 5.549-2.48 5.549-5.53v-73.331h2.127v26.355c0 2.275 1.85 4.123 4.126 4.123 2.28 0 4.073-1.846 4.073-4.123v-29.23c0-6.663-5.463-12.07-12.129-12.07h-20.82z"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="37.5 7.5 50 120" fill="black" stroke="#777777" stroke-width="0.5">
                <path d="m62.096 8.5859c-5.208 0-9.424 4.2191-9.424 9.4261 0.001 5.203 4.217 9.424 9.424 9.424 5.202 0 9.422-4.221 9.422-9.424 0-5.208-4.22-9.4261-9.422-9.4261zm-10.41 21.268c-6.672 0-12.131 5.407-12.131 12.07v29.23c0 2.275 1.791 4.123 4.07 4.123 2.28 0 4.127-1.846 4.127-4.123v-26.355h2.102s0.048 68.811 0.048 73.331c0 3.05 2.478 5.53 5.532 5.53 3.052 0 5.525-2.48 5.525-5.53v-42.581h2.27v42.581c0 3.05 2.473 5.53 5.531 5.53 3.054 0 5.549-2.48 5.549-5.53v-73.331h2.127v26.355c0 2.275 1.85 4.123 4.126 4.123 2.28 0 4.073-1.846 4.073-4.123v-29.23c0-6.663-5.463-12.07-12.129-12.07h-20.82z"/>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="37.5 7.5 50 120" fill="black" stroke="#777777" stroke-width="0.5">
                <path d="m62.096 8.5859c-5.208 0-9.424 4.2191-9.424 9.4261 0.001 5.203 4.217 9.424 9.424 9.424 5.202 0 9.422-4.221 9.422-9.424 0-5.208-4.22-9.4261-9.422-9.4261zm-10.41 21.268c-6.672 0-12.131 5.407-12.131 12.07v29.23c0 2.275 1.791 4.123 4.07 4.123 2.28 0 4.127-1.846 4.127-4.123v-26.355h2.102s0.048 68.811 0.048 73.331c0 3.05 2.478 5.53 5.532 5.53 3.052 0 5.525-2.48 5.525-5.53v-42.581h2.27v42.581c0 3.05 2.473 5.53 5.531 5.53 3.054 0 5.549-2.48 5.549-5.53v-73.331h2.127v26.355c0 2.275 1.85 4.123 4.126 4.123 2.28 0 4.073-1.846 4.073-4.123v-29.23c0-6.663-5.463-12.07-12.129-12.07h-20.82z"/>
        ...
        <div id="ratio-text"><span>Your establishment is at <span id="occupancy-ratio-placeholder">80%</span> capacity</span></div>
        <div id="fraction-text"></div>
    </div>
`;

const underDevItemTemplate = document.createElement('template');
underDevItemTemplate.innerHTML = `
    <div class="under-dev-item">
        <div class="under-dev-text">Section under development</div>
    </div>
    <div class="blurred-container">
        <div class="blurred-div"></div>
        <div class="blurred-div"></div>
        <div style="text-align:center">This is some random text to make it look like there is some information</div>
        <div class="blurred-div"></div>
    </div>
`;

const infoIconTemplate = document.createElement('template');
infoIconTemplate.innerHTML = `
    <div class="info-icon-container">
        <svg class="info-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 22Q9.925 22 8.1 21.212Q6.275 20.425 4.925 19.075Q3.575 17.725 2.788 15.9Q2 14.075 2 12Q2 9.925 2.788 8.1Q3.575 6.275 4.925 4.925Q6.275 3.575 8.1 2.787Q9.925 2 12 2Q14.075 2 15.9 2.787Q17.725 3.575 19.075 4.925Q20.425 6.275 21.212 8.1Q22 9.925 22 12Q22 14.075 21.212 15.9Q20.425 17.725 19.075 19.075Q17.725 20.425 15.9 21.212Q14.075 22 12 22ZM12 9Q12.425 9 12.713 8.712Q13 8.425 13 8Q13 7.575 12.713 7.287Q12.425 7 12 7Q11.575 7 11.288 7.287Q11 7.575 11 8Q11 8.425 11.288 8.712Q11.575 9 12 9ZM11 17H13V11H11Z"/></svg>        <div class="info-container">
            <span class="info-text">This is just some random text to test</span>
        </div>
    </div>
`;
...
class DashboardGrid extends HTMLElement {
    styles;
    Areas = [];
    dummySingleRoundsData = [
        [
            {done: 17, undone: 3, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 18, undone: 2, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 17, undone: 3, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 16, undone: 4, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 12, undone: 8, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0}
        ],
        [
            {done: 17, undone: 3, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 18, undone: 2, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
        ...
        [
            {done: 17, undone: 3, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 18, undone: 2, comingUp: 0, UNDERWAY_FLAG:0, COMINGUP_FLAG:0},
            {done: 12, undone: 0, comingUp: 8, UNDERWAY_FLAG:1, COMINGUP_FLAG:0},
            {done: 0, undone: 0, comingUp: 20, UNDERWAY_FLAG:0, COMINGUP_FLAG:1},
            {done: 0, undone: 0, comingUp: 20, UNDERWAY_FLAG:0, COMINGUP_FLAG:1}
        ],
        [
            {done: 0, undone: 0, comingUp: 20, UNDERWAY_FLAG:0, COMINGUP_FLAG:1},
    ...
    dummyRoundsTimes = [3600, 10800, 18000, 25200, 82800];
    dummyGracePeriod = 1200;
    dummyTotalRooms = 20;
    dummyOccupiedRooms = 15;
    dailyRoundsData = [];
    weeklyRoundsData;
    dummyToday = 5;
    state;
    ...
    constructor() {
        ...
        try{
            for(let i=0 ; i<4 ; i++){
                this.Areas.push(this.getnthArea(i+1));
            }
        }catch(e){
            console.error(e);
        }
    ...
    connectedCallback(){
        ...
        setTimeout(()=>{
            this.stopLoading();
            this.shadowRoot.querySelector('#data-timestamp').innerHTML = `Last data query: ${new Date().toISOString()}`;
            this.state1();
        }, 5000)
    };
    ...
    setRoundData(){
        // SETTING THE SINGLE ROUND DATA FIRST

        // THEN USING THE SINGLE ROUND DATA TO SET THE DAILY ROUND DATA
        this.dummySingleRoundsData.forEach(dailyRounds =>{
            let done = 0;
            let undone = 0;
            let comingUp = 0;
            let UNDERWAY_FLAG = false;
            let COMINGUP_FLAG = true;
            dailyRounds.forEach(round =>{
                done += round.done;
                undone += round.undone;
                comingUp += round.comingUp;
                if(round.UNDERWAY_FLAG){
                    UNDERWAY_FLAG = true;
                }
                if(!(round.COMINGUP_FLAG)){
                    COMINGUP_FLAG = false;
                }
            });
            let dailyRound = {done, undone, comingUp, UNDERWAY_FLAG, COMINGUP_FLAG};
            this.dailyRoundsData.push(dailyRound);
        });

        // THEN USING THE DAILY ROUND DATA TO SET THE WEEKLY ROUND DATA
        {
            let done = 0;
            let undone = 0;
            let comingUp = 0;
            this.dailyRoundsData.forEach(roundData =>{
                done += roundData.done;
                undone += roundData.undone;
                comingUp += roundData.comingUp;
            });
            this.weeklyRoundsData = {done, undone, comingUp, UNDERWAY_FLAG:false, COMINGUP_FLAG:false};
        }
    }

    // Configuring the dailyRoundsItem
    getDailyRoundsItem(){
        let dailyRoundsItem = gridAreaLayoutTemplate.content.cloneNode(true);
        dailyRoundsItem.querySelector('.grid-area-title').innerHTML = `Today's rounds`;
        this.appendPieChart(dailyRoundsItem.querySelector('.grid-area-article'), this.dailyRoundsData[this.dummyToday]);
        dailyRoundsItem.querySelector('.more-link').addEventListener('click', ()=>{
            this.state2();
        });
        return dailyRoundsItem;
    };

    // Configuring the WeeklyRoundsItem
    getWeeklyRoundsItem(){
        let weeklyRoundsItem = gridAreaLayoutTemplate.content.cloneNode(true);
        weeklyRoundsItem.querySelector('.grid-area-title').innerHTML = `Weekly rounds`;
        this.appendPieChart(weeklyRoundsItem.querySelector('.grid-area-article'), this.weeklyRoundsData);
        weeklyRoundsItem.querySelector('.more-link').addEventListener('click', ()=>{
            console.log('clicked on it');
            this.state3();
        });
        return weeklyRoundsItem;
    };

    // Configuring the dailyRoundsBreakdownItem
    setDailyRoundsBreakdownItem(container, dayOfWeek, callback){
        let dailyRoundsBreakdownItem = gridAreaLayoutTemplate.content.cloneNode(true);
        dailyRoundsBreakdownItem.querySelector('.grid-area-title').innerHTML = `${this.dummyToday == dayOfWeek ? 'Today':this.daysOfWeek[dayOfWeek]}'s rounds`;
        dailyRoundsBreakdownItem.querySelector('.back-link').addEventListener('click', callback);
        dailyRoundsBreakdownItem.querySelector('.more-link').style.display = 'none';
        container.appendChild(dailyRoundsBreakdownItem);
        let gridAreaContentContainer = document.createElement('div');
        gridAreaContentContainer.classList.add('charts-container');
        this.dummySingleRoundsData[dayOfWeek].forEach((roundData, index) =>{
            let status = 'Done';
            let gridItem = chartsItemTemplate.content.cloneNode(true);
            if(roundData.COMINGUP_FLAG){
                gridItem.querySelector('.charts-item').classList.add('coming-up');
                status = 'Coming up';
            }else if(roundData.UNDERWAY_FLAG){
                status = 'Ongoing';
            }
            let infoIconElement = infoIconTemplate.content.cloneNode(true);
            infoIconElement.querySelector('.info-text').innerHTML = `
                <span style="font-weight:bold;">Status:</span> ${status}  
                <br> 
                <span style="font-weight:bold;">Time:</span> ${new Date(this.dummyRoundsTimes[index] * 1000).toISOString().substring(11, 16)} - ${new Date((this.dummyRoundsTimes[index] + this.dummyGracePeriod) * 1000).toISOString().substring(11, 16)}`;
            gridItem.querySelector('.charts-title-container').appendChild(infoIconElement);
            gridItem.querySelector('.charts-title-text').innerHTML = `Round ${index + 1}`;
            console.log(gridItem);
            console.log(gridItem.querySelector('.charts-article'));
            this.appendPieChart(gridItem.querySelector('.charts-article'), roundData);
            gridAreaContentContainer.appendChild(gridItem);
        });
        container.querySelector('.grid-area-article').appendChild(gridAreaContentContainer);
    }

    setWeeklyRoundsBreakdownItem(container){
        let weeklyRoundsBreakdownItem = gridAreaLayoutTemplate.content.cloneNode(true);
        weeklyRoundsBreakdownItem.querySelector('.grid-area-title').innerHTML = `This week's rounds`;
        weeklyRoundsBreakdownItem.querySelector('.back-link').addEventListener('click', ()=>{
            this.state1();
        });
        weeklyRoundsBreakdownItem.querySelector('.more-link').style.display = 'none';
        container.appendChild(weeklyRoundsBreakdownItem);
        let gridAreaContentContainer = document.createElement('div');
        gridAreaContentContainer.classList.add('charts-container');
        this.dailyRoundsData.forEach((roundData, index) =>{
            let gridItem = chartsItemTemplate.content.cloneNode(true);
            let gridItemContainer = gridItem.querySelector('.charts-item');
            if(roundData.COMINGUP_FLAG){
                gridItemContainer.classList.add('coming-up');
                // gridItemContainer.querySelector('.more-link').style.display = 'none';
            }else{
                gridItemContainer.addEventListener('click', ()=>{
                    this.state4(index);
                });
                if(roundData.UNDERWAY_FLAG){
                }
            }
            gridItem.querySelector('.charts-title-text').innerHTML = `${this.daysOfWeek[index]}`;
            this.appendPieChart(gridItem.querySelector('.charts-article'), roundData);
            gridAreaContentContainer.appendChild(gridItem);
        });
        container.querySelector('.grid-area-article').appendChild(gridAreaContentContainer);
    ...
    setEstablishmentOverviewGridItem(container){
        let ratio = Math.floor(this.dummyOccupiedRooms/this.dummyTotalRooms*100);
        let progress = 0;
        if(ratio >= 80){
            var ratioColor = 'green';
        }else if(ratio >= 50){
            var ratioColor = 'orange';
        }else{
            var ratioColor = 'red'
        }
        let gridLayout = gridAreaLayoutTemplate.content.cloneNode(true);

        let gridItem = EstablishmentOccupancyGridItemTemplate.content.cloneNode(true);
        let occupancyRatioPlaceholder = gridItem.querySelector('#occupancy-ratio-placeholder');
        occupancyRatioPlaceholder.innerHTML = `${ratio}%`;
        occupancyRatioPlaceholder.style.color = ratioColor;

        let occupancyPictogram = gridItem.querySelector('#occupancy-pictogram');
        occupancyPictogram.querySelectorAll('svg').forEach(svg =>{
            progress += 10;
            if(progress >= ratio){
                if(progress > ratio){
                    occupancyPictogram.querySelector('stop:nth-of-type(2)').setAttribute('offset', `${100-(progress-ratio)*10}%`);
        ...
        gridItem.querySelector('#fraction-text').innerHTML = `(${this.dummyOccupiedRooms}/${this.dummyTotalRooms})`;
        gridLayout.querySelector('.back-link').style.display = 'none';
        gridLayout.querySelector('.grid-area-title').innerHTML = `Establishment Overview`;
        gridLayout.querySelector('.grid-area-article').appendChild(gridItem);
        container.appendChild(gridLayout);

    }

    setEmployeesAndScheduleGridItem(container){
        let gridLayout = gridAreaLayoutTemplate.content.cloneNode(true);
        gridLayout.querySelector('.back-link').style.display = 'none';
        gridLayout.querySelector('.grid-area-title').innerHTML = `Employees and Schedule`;
        gridLayout.querySelector('.grid-area-article').appendChild(underDevItemTemplate.content.cloneNode(true));
        container.appendChild(gridLayout);
    }

    getnthArea(areaIndex){
        if((this.shadowRoot.querySelector('#dashboard-grid').childElementCount >= areaIndex) && (areaIndex > 0)){
            return this.shadowRoot.querySelector(`#dashboard-grid > div:nth-child(${areaIndex})`);
        }else{
    ...
    clearAreas(){
        for(let i = 0 ; i < this.Areas.length ; i++){
            while(this.Areas[i].children.length > 0){
                this.Areas[i].removeChild(this.Areas[i].children[0]);
            } 
        }
    }
    ...
    startLoading(){
        this.clearAreas();
        this.shadowRoot.querySelector('#dashboard-grid').classList.add('shimmer');
    }

    stopLoading(){
        this.shadowRoot.querySelector('#dashboard-grid').classList.remove('shimmer');
    }

    appendPieChart(container, values){
        // Load google charts
        ...
        function drawChart() {
          ...
          ['Rounds', 'Amount'],
          ['Completed', values.done],
          ['Not completed', values.undone],
          ['Coming up', values.comingUp]
        ]);
        
          // Optional; add a title and set the width and height of the chart
          var options = {'colors':['#77dd77', '#ff5050', 'e6e6fa'], 'legend':{position:'bottom'}, 'chartArea':{width:'70%', height:'70%'}, 'backgroundColor':'transparent', 'pieSliceTextStyle':{color:'black'}};
    ...
    state1(){
        // Clearing all the content of the grid areas
        this.clearAreas();

        // Applying styles that are specific to state 1
        ...
        this.Areas[0].appendChild(this.getDailyRoundsItem());
        this.Areas[1].appendChild(this.getWeeklyRoundsItem());
        this.setEstablishmentOverviewGridItem(this.Areas[2]);
        this.setEmployeesAndScheduleGridItem(this.Areas[3]);
        this.state = 'state1';
    }
    ...
    state2(){
        ...
        // Applying styles that are specific to state 2
        this.styles.innerHTML = `
            #dashboard-grid{
                grid-template-columns: 1fr 1fr;
                grid-template-rows: 375px 1fr;
                grid-template-areas: "areaOne areaOne"
                "areaThree areaFour"
            }
        ...
        `
        this.shadowRoot.appendChild(this.styles);
        this.setDailyRoundsBreakdownItem(this.Areas[0], this.dummyToday, ()=> this.state1());
        this.setEstablishmentOverviewGridItem(this.Areas[2]);
        this.setEmployeesAndScheduleGridItem(this.Areas[3]);
        this.state = 'state2';
    }
    ...
    state3(){
        ...
        this.styles.innerHTML = `
            #dashboard-grid{
                grid-template-columns: 1fr 1fr;
                grid-template-rows: 375px 1fr;
                grid-template-areas: "areaTwo areaTwo"
                "areaThree areaFour"
            }
        ...
        `
        this.shadowRoot.appendChild(this.styles);
        this.setWeeklyRoundsBreakdownItem(this.Areas[1]);
        this.setEstablishmentOverviewGridItem(this.Areas[2]);
        this.setEmployeesAndScheduleGridItem(this.Areas[3]);
        this.state = 'state3';
    }
    ...
    state4(dayOfWeek){
        ...
        `
        this.shadowRoot.appendChild(this.styles);
        this.setDailyRoundsBreakdownItem(this.Areas[1], dayOfWeek, ()=> this.state3());
        this.setEstablishmentOverviewGridItem(this.Areas[2]);
        this.setEmployeesAndScheduleGridItem(this.Areas[3]);
        this.state = 'state4';
    }
